...
namespace HOS
{
    public class ClothFragmentController : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            if (MovementScript.CurrentWaypoint == MovementScript.WaypointList[2] && !HMCManager.ClothFound)
            {
        ...
        private void OnMouseDown()
        {
            if (Clickable)
            {
                ...
                HMCManager.ClothFound = true;
                TextArea.text = "That cloth is stuck inside the stone. This must have some kind of door!";
